      ...
      >
        ...
        >
          ...
          <View style={styles.copySection}>
            <Text style={[styles.copyTitle, { color: palette.textPrimary }]}>Create account</Text>
            <Text style={[styles.copySubtitle, { color: palette.textMuted }]}>
              Register to sync your protocols across devices.
            </Text>
          </View>
          ...
          <View style={[styles.authCard, {
            ...
            {info ? (
              <View style={[styles.infoBanner, { backgroundColor: isDark ? '#1C1917' : '#F5F5F4', borderColor: isDark ? '#292524' : '#E7E5E4' }]}>
                <FontAwesome name="info-circle" size={13} color={palette.textSecondary} />
                <Text style={[styles.infoText, { color: palette.textSecondary }]}>{info}</Text>
              </View>
            ) : null}
            ...
            >
              <Text style={styles.authCTAText}>{loading ? 'Creating…' : 'Create account'}</Text>
            </Pressable>
