  ...
  return (
    <div className="pt-2 pb-20 min-h-screen">
      ...
      <div className="flex items-center justify-between mb-6 px-1 py-4">
        ...
        <span className="text-xs font-bold text-stone-400 uppercase tracking-widest">Research Reference</span>
        <div className="w-8" />
      </div>
      ...
      <div className="space-y-6">
        ...
        <section className="bg-white p-6 rounded-[32px] shadow-sm border border-stone-50">
            <div className="flex items-center space-x-2 mb-4">
                ...
                <h2 className="text-xs font-bold text-stone-900 uppercase tracking-widest">Research Context</h2>
            </div>
            <p className="text-sm text-stone-500 mb-4 italic">In research settings, this compound has been investigated in models involving:</p>
        ...
        {/* Mechanism */}
        <section className="bg-white p-6 rounded-[32px] shadow-sm border border-stone-50">
            <h2 className="text-xs font-bold text-stone-900 uppercase tracking-widest mb-4">Mechanism of Interest</h2>
            <p className="text-sm text-stone-600 leading-relaxed">
                {entry.mechanism}
            </p>
        </section>
        ...
        <section className="bg-stone-50 p-6 rounded-[32px] border border-stone-100">
            <div className="flex items-center space-x-2 mb-4">
                ...
                <h2 className="text-xs font-bold text-stone-900 uppercase tracking-widest">Research Limitations</h2>
            </div>
            <p className="text-sm text-stone-600 leading-relaxed">
                {entry.limitations}
            </p>
        ...
        <section className="bg-white p-6 rounded-[32px] shadow-sm border border-stone-50">
            <div className="flex items-center space-x-2 mb-4">
                ...
                <h2 className="text-xs font-bold text-stone-900 uppercase tracking-widest">Regulatory Status</h2>
            </div>
            <p className="text-sm text-stone-600 leading-relaxed">
        ...
        <section className="px-4">
            <div className="flex items-center space-x-2 mb-4 opacity-60">
                ...
                <h2 className="text-xs font-bold text-stone-500 uppercase tracking-widest">Selected References</h2>
            </div>
            <ul className="space-y-4">
                {entry.references.map((ref, idx) => (
                    <li key={idx} className="text-[11px] text-stone-400 leading-relaxed font-medium bg-white p-3 rounded-xl border border-stone-50">
                        {ref}
                    </li>
                ))}
            </ul>
        ...
        <div className="mt-8 px-6 text-center border-t border-stone-100 pt-8">
            <p className="text-[10px] text-stone-400 leading-relaxed">
                This content is provided for educational reference only. The app does not provide medical advice or dosing guidance.
            </p>
        </div>
