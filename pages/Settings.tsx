  ...
  return (
    <div className="pt-2 space-y-8 pb-24 bg-[#F8F9FB] dark:bg-stone-950 transition-colors duration-300 min-h-screen">
      ...
      <section className="space-y-4">
        <h2 className="text-xs font-bold text-stone-400 dark:text-stone-500 uppercase tracking-widest ml-2">
          Preferences
        </h2>
        <div className="bg-white dark:bg-stone-900 rounded-[32px] border border-stone-50 dark:border-stone-800 overflow-hidden shadow-sm p-6 space-y-6">
          ...
          <div>
            <div className="flex items-center space-x-2 mb-3">
              ...
              <span className="font-bold text-stone-900 dark:text-stone-200 text-sm">
                Unit System
              </span>
            </div>
        ...
        <div className="bg-white dark:bg-stone-900 rounded-[32px] border border-stone-50 dark:border-stone-800 overflow-hidden shadow-sm p-6 space-y-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <p className="font-bold text-stone-900 dark:text-stone-200 text-sm">
                  Push Notifications
                </p>
            ...
            >
              <div
                className={`absolute top-1 w-5 h-5 bg-white dark:bg-stone-900 rounded-full transition-transform shadow-sm ${settings.notifications.push ? 'left-6' : 'left-1'}`}
              />
            </button>
          </div>
          ...
          <div className="flex items-center justify-between">
            ...
            >
              <div
                className={`absolute top-1 w-5 h-5 bg-white dark:bg-stone-900 rounded-full transition-transform shadow-sm ${settings.notifications.reminders ? 'left-6' : 'left-1'}`}
              />
            </button>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-stone-900 rounded-[32px] border border-stone-50 dark:border-stone-800 overflow-hidden shadow-sm p-2">
          ...
          <div className="p-4 mt-1 border-t border-stone-50 dark:border-stone-800">
            <div className="bg-pastel-yellow/30 p-4 rounded-2xl flex items-start space-x-3">
              ...
              <div>
                <p className="text-xs font-bold text-stone-800 dark:text-stone-200 uppercase mb-1">
                  Medical Disclaimer
                </p>
                <p className="text-xs text-stone-600 dark:text-stone-400 leading-relaxed">
                  This application is for informational and educational purposes only. It is not
      ...
      <section className="space-y-4">
        ...
        <div className="bg-white dark:bg-stone-900 rounded-[32px] border border-stone-50 dark:border-stone-800 overflow-hidden shadow-sm">
          ...
          >
            <div className="flex items-center text-stone-800 dark:text-stone-200">
              <div
                className={`w-10 h-10 rounded-2xl flex items-center justify-center mr-4 ${resetConfirm ? 'bg-red-100 text-red-500' : 'bg-stone-100 dark:bg-stone-800 text-stone-500'}`}
              >
                <Trash2 size={20} />
              </div>
              <div className="text-left">
                <p
                  className={`font-bold text-sm ${resetConfirm ? 'text-red-600 dark:text-red-400' : ''}`}
                >
                  {resetConfirm ? 'Tap again to confirm wipe' : 'Reset All Data'}
                </p>
                <p className="text-xs text-stone-400 dark:text-stone-500 font-medium">
                  Clear local storage
                </p>
